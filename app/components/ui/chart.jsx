...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "tw:border-border/50 tw:bg-background tw:gap-1.5 tw:rounded-lg tw:border tw:px-2.5 tw:py-1.5 tw:text-xs tw:shadow-xl tw:grid tw:min-w-32 tw:items-start",
        className
      )}>
                ...
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    ...
                    <div
                      ...
                      {item.value && (
                        <span
                          className="tw:text-foreground tw:font-mono tw:font-medium tw:tabular-nums">

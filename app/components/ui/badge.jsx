...
const badgeVariants = cva(
  "tw:h-5 tw:gap-1 tw:rounded-4xl tw:border tw:border-transparent tw:px-2 tw:py-0.5 tw:text-xs tw:font-medium tw:transition-all tw:has-data-[icon=inline-end]:pr-1.5 tw:has-data-[icon=inline-start]:pl-1.5 tw:[&>svg]:size-3! tw:inline-flex tw:items-center tw:justify-center tw:w-fit tw:whitespace-nowrap tw:shrink-0 tw:[&>svg]:pointer-events-none tw:focus-visible:border-ring tw:focus-visible:ring-ring/50 tw:focus-visible:ring-[3px] tw:aria-invalid:ring-destructive/20 tw:dark:aria-invalid:ring-destructive/40 tw:aria-invalid:border-destructive tw:overflow-hidden tw:group/badge",
  {
    variants: {
      variant: {

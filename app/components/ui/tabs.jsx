...
function Tabs({
  ...
  return (
    <TabsPrimitive.Root
      ...
      className={cn("tw:group/tabs tw:flex tw:gap-2 tw:flex-col", className)}
      {...props} />
  );
}
